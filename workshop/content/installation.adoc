...
You'll notice that there is a 4-digit alphanumeric string (eg: f4a3) in the hostname by running the hostname command.
[source,bash,role="execute"]
----
hostname
----
...
This string is your `GUID`. Since you will often use `GUID`, it makes sense to
