...
[source,bash,role="execute"]
----
cat {{ HOME_PATH }}/content/support/project_request_template.yaml
----
...
[source,bash,role="execute"]
----
oc create -f {{ HOME_PATH }}/content/support/project_request_template.yaml -n openshift-config
----
...
[source,bash,role="execute"]
----
oc apply -f {{ HOME_PATH }}/content/support/cr_project_request.yaml -n openshift-config
----
